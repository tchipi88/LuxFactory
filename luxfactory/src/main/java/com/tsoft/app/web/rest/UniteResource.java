...
public class UniteResource {
    ...
    @PostMapping("/unites")
    @Timed
    public ResponseEntity<Unite> createUnite(@Valid @RequestBody Unite unite) throws Exception {
    ...
    @PutMapping("/unites")
    @Timed
    public ResponseEntity<Unite> updateUnite(@Valid @RequestBody Unite unite) throws Exception {
