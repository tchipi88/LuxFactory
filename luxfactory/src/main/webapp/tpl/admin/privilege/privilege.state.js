    ...
    function stateConfig($stateProvider) {
        $stateProvider
                .state('privilege', {
                    ...
                    views: {
                        'content@app': {
                            templateUrl: 'tpl/admin/privilege/privileges.html',
                ...
                .state('privilege-detail', {
                    ...
                    views: {
                        'content@app': {
                            templateUrl: 'tpl/admin/privilege/privilege-detail.html',
                ...
                .state('privilege-detail.edit', {
                    ...
                    onEnter: ['$stateParams', '$state', '$uibModal', function ($stateParams, $state, $uibModal) {
                            $uibModal.open({
                                templateUrl: 'tpl/admin/privilege/privilege-dialog.html',
                ...
                .state('privilege.delete', {
                    ...
                    onEnter: ['$stateParams', '$state', '$uibModal', function ($stateParams, $state, $uibModal) {
                            $uibModal.open({
                                templateUrl: 'tpl/admin/privilege/privilege-delete-dialog.html',
