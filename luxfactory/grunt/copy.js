        ...
        files:[
            {
                ...
                dest: 'src/main/webapp/tkbr/libs/angular',
            ...
            },
            {
                ...
                dest: 'src/main/webapp/tkbr/libs/jquery',
                cwd:  'src/main/webapp/bower_components',
                expand: true
            },
            {
                ...
                dest: 'src/main/webapp/tkbr/libs/assets',
                cwd:  'src/main/webapp/bower_components',
                expand: true
            },
            {src: '**', cwd: 'src/main/webapp/bower_components/bootstrap/dist/fonts', dest: 'src//main/webapp/tkbr/fonts', expand: true}
        ]
    },
    angular: {
        files: [
            {expand: true, src: ['**', '!**/less/**'], cwd: 'src/main/webapp/',   dest: "src/main/webapp/tkbr/"}
        ]
    },
    html: {
        files: [
