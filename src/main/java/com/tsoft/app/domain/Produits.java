 ...
 */
@Entity
public class Produits extends AbstractAuditingEntity {
    ...
    public Produits getParent() {
        return parent;
    }

    public void setParent(Produits parent) {
        this.parent = parent;
    }
    ...
    public String toString() {
        return "com.tsoft.app.domain.Produits[ id=" + id + " ]";
    }
