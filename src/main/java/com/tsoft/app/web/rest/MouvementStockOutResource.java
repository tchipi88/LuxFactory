...
public class MouvementStockOutResource {
     ...
     * new mouvementStockOut, or with status 400 (Bad Request) if the
     * mouvementStockOut has already an ID
     ...
     * mouvementStockOut, or with status 400 (Bad Request) if the
     * mouvementStockOut is not valid, or with status 500 (Internal Server
     * Error) if the mouvementStockOut couldnt be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
     ...
     * mouvementStockOut, or with status 404 (Not Found)
     */
