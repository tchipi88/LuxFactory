...
public class MouvementStockInResource {
     ...
     * @return the ResponseEntity with status 201 (Created) and with body the new mouvementStockIn, or with status 400 (Bad Request) if the mouvementStockIn has already an ID
     ...
     * @return the ResponseEntity with status 200 (OK) and with body the updated mouvementStockIn,
     * or with status 400 (Bad Request) if the mouvementStockIn is not valid,
     * or with status 500 (Internal Server Error) if the mouvementStockIn couldnt be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
     ...
     *
     * @return the ResponseEntity with status 200 (OK) and the list of mouvementStockIns in body
     */
     ...
     * @return the ResponseEntity with status 200 (OK) and with body the mouvementStockIn, or with status 404 (Not Found)
     */
